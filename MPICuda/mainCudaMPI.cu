...
void printHeader(){
    ...
    std::cout << "\n\t|| "<<std::left
              ...
              <<std::setw(COL2to10)<<"inputPrepMaster Avg"<<"|| "
              <<std::setw(COL2to10)<<"inputPrepMaster Std"<<"|| "
              <<std::setw(COL2to10)<<"outputPrepMaster Avg"<<"|| "
              <<std::setw(COL2to10)<<"outputPrepMaster Std"<<"|| "
              ...
              <<std::setw(COL2to10)<<"calcTimeMaster Avg"<<"|| "
              <<std::setw(COL2to10)<<"calcTimeMaster Std"<<"|| "
