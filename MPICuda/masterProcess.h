...
class MasterProcess: public MPIBase {
public:

    MasterProcess(int vectorSize){ //int comType, int vectorSize, int avg
    ...
    std::vector<float> part1() override {
        ...
        endTimeInputMaster = MPI_Wtime(); //timeinputprep root 

        returnRes[0] = (endTimeInputMaster - startTime) * 1000;
        ...
        returnRes[5] = (startTime - endTimeInputMaster)*1000 ; // calc on root POV
...
// the result vector is like this [inputPrepMaster, outputPrepMaster, inputPrepHost, outputPrepHost, calcTimeMaster, calcTimeHost, calcTimeDevice]
    ...
    float endTime, endTimeInputMaster;  
    float startTime;
    ...
    void checkResult(std::vector<float> resultVect){
            ...
            std::cout << "\n-------------------------------------------------------\n";
            std::cout << "| MasterSum | WorksSum | Error   | Error %  | Process # |";
            std::cout << "\n-------------------------------------------------------\n";
